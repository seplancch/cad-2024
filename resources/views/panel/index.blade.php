        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-6 mb-6">
            ...
            @if($semestre != 6)
                <div class="bg-white rounded-md border border-gray-100 p-6 shadow-md shadow-black/5">
                    ...
                    @if($serviciosUnamCompleto != 1)
                        <!-- Modal de advertencia para salir a sistema externo -->
                        <div x-data="{ showModal: false }">
                            ...
                            <!-- Modal -->
                            <div x-show="showModal" class="fixed inset-0 flex items-center justify-center z-50 bg-gray-900 bg-opacity-60" style="display: none;" x-transition>
                                <div class="bg-white rounded-lg shadow-lg max-w-md w-full p-6">
                                    <div class="flex items-center mb-4">
                                        <svg class="w-8 h-8 text-yellow-500 mr-2" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M13 16h-1v-4h-1m1-4h.01M12 20a8 8 0 100-16 8 8 0 000 16z" />
                                        </svg>
                                        <h3 class="text-lg font-bold text-gray-800">Vas a salir del sistema CAD</h3>
                                    </div>
                                    <p class="text-gray-700 mb-4">Serás redirigido a un sistema externo para contestar el cuestionario de opinión sobre los servicios de la UNAM.<br>
                                    <span class="font-semibold text-red-600">Te recomendamos hacer este cuestionario en una computadora, ya que en el celular puede verse mal o ser difícil de usar.</span></p>
                                    <div class="flex justify-end space-x-2">
                                        <button @click="showModal = false" class="px-4 py-2 bg-gray-200 text-gray-800 rounded hover:bg-gray-300">Cancelar</button>
                                        <a href="https://cad.cch.unam.mx/servicios-unam" class="px-4 py-2 bg-green-600 text-white rounded hover:bg-green-700" target="_blank" rel="noopener">Continuar</a>
                                    </div>
                                </div>
                            </div>
                        </div>
