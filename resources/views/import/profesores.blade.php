            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                ...
                <div class="px-6 py-4 bg-gradient-to-r from-yellow-50 to-yellow-100 border-b border-yellow-200">
                    <div class="flex items-center justify-between">
                        <div>
                            <h2 class="text-xl font-semibold text-gray-800">Importar Profesores</h2>
                ...
                <div class="p-6">
                    ...
                    <div class="bg-white rounded-lg border border-gray-200 p-6">
                        <form id="upload-form" action="{{ route('importaProfesores') }}" method="post" enctype="multipart/form-data" class="space-y-6">
                            @csrf
                            ...
                            <div class="bg-yellow-50 border-l-4 border-yellow-400 p-4 rounded-r-lg">
                                <div class="flex">
                                    ...
                                    <div class="ml-3">
                                        <h3 class="text-sm font-medium text-yellow-800">Formato Requerido</h3>
                                        <div class="mt-2 text-sm text-yellow-700">
                                            ...
                                            <ul class="list-disc pl-5 mt-1 space-y-1">
                                                ...
                                                <li>Columnas requeridas: numero_trabajador, nombre, email, plantel_id</li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="mt-6">
                                ...
                                <div class="mt-1">
                                    ...
                                    <div class="flex flex-col items-center justify-center p-6 border-2 border-dashed border-gray-300 rounded-lg bg-white hover:bg-gray-50 transition-colors duration-200">
                                        ...
                                        <div id="selected-file" class="mt-4 text-sm text-yellow-600 font-medium">
                            ...
                            <div class="flex justify-end space-x-3">
                                <a href="{{ route('dashboard') }}" class="inline-flex items-center px-4 py-2 border border-gray-300 rounded-md font-semibold text-xs text-gray-700 uppercase tracking-widest shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-yellow-500 focus:ring-offset-2 disabled:opacity-25 transition">
                                    Cancelar
                                </a>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function handleFile(file) {
        ...
        if (file.type === 'text/csv' || file.name.toLowerCase().endsWith('.csv')) {
            ...
            selectedFileDisplay.className = 'mt-4 text-sm text-yellow-600 font-medium';
