<x-app-layout>
        <!-- Incluye los archivos compilados -->
        @vite(['resources/css/fileupload.css'])
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 p-4">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-6 py-4">
                ...
                <form id="upload-form" action="{{ route('importaProfesores') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <!-- file upload modal -->

                </form>
                <article id="fileupload" aria-label="File Upload Modal" class="relative h-full flex flex-col bg-white shadow-xl rounded-md" ondrop="dropHandler(event);" ondragover="dragOverHandler(event);" ondragleave="dragLeaveHandler(event);" ondragenter="dragEnterHandler(event);">
                    <!-- overlay -->
...
<style>
    #fileupload .hasImage:hover section {
        background-color: rgba(5, 5, 5, 0.4);
    }
    #fileupload .hasImage:hover button:hover {
    ...
    #fileupload #overlay.draggedover {
        background-color: rgba(255, 255, 255, 0.7);
    }
    #fileupload #overlay.draggedover p,
    #fileupload #overlay.draggedover i {
        opacity: 1;
    }

    #fileupload .group:hover .group-hover\:text-blue-800 {
        color: #2b6cb0;
    }
...
<script>
    //https://www.creative-tim.com/twcomponents/component/file-upload-with-drop-on-and-preview
