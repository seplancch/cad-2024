...
<style is:global lang="scss">
    :root {
      --cad-red: 230 57 70;
      --cad-blue: 28 110 140;
      --cad-blue-light: 199 248 255;
      --cad-orange: 240 150 45;
      --cad-brown: 142 114 88;
      --cad-green: 0 161 137;
      --cad-light: 230 244 241;
      --cad-dark: 0 28 53;
...
<body>
    <header class="bg-bluelight w-full py-4 z-50 top-0 hover:transition-all sticky">
        <div class="mx-auto">
            <nav class="navbar md:px-5 mx-auto flex items-center justify-between">
                ...
                <ul id="nav-menu" class="navbar-nav order-1 xl:text-lg cursor-pointer flex w-auto space-x-2 xl:space-x-8 text-dark font-semibold uppercase">
                    <li><a href="{{ route('home') }}">Inicio</a></li>
                    <li><a href="{{ route('que-es') }}">¿Qué es?</a></li>
                    <li><a href="{{ route('preguntas-frecuentes') }}">Preguntas</a></li>
