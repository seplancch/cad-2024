                ...
                <div class="p-6">
                    <form action="{{ route('configuracion.update', $configuracion) }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="nombre" id="nombre" value="{{ old('nombre', $configuracion->nombre) }}" required
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="valor" id="valor" value="{{ old('valor', $configuracion->valor) }}" required
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="descripcion" id="descripcion" rows="3"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm @error('descripcion') border-red-500 @enderror">{{ old('descripcion', $configuracion->descripcion) }}</textarea>
                            @error('descripcion')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
