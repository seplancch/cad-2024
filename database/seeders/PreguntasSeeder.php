    ...
    public function run(): void
    {
        ...
        foreach ($preguntas as $preguntaData) {
            $pregunta = Pregunta::create([
                'cuestionario_id' => $preguntaData['cuestionario_id'],
                'rubro_id' => $preguntaData['rubro_id'],
                'titulo' => $preguntaData['titulo'],
            ]);

            $respuestas = [
                $preguntaData['opcion_1'],
                $preguntaData['opcion_2'],
                $preguntaData['opcion_3'],
                $preguntaData['opcion_4'],
                $preguntaData['opcion_5'],
            ];
            $cont = 1;
